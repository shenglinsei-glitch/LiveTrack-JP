...
export const ConcertSection: React.FC<ConcertSectionProps> = ({ concert, now }) => {
  ...
  return (
    <div className={`flex flex-col p-4 md:p-6 rounded-[2.5rem] border transition-all ${getBgColor(latestPerformance)} mb-4 shadow-sm hover:shadow-md`}>
        ...
        <div className="flex-grow pt-1">
          ...
          <div className="space-y-3">
            {concert.performances.map(perf => {
              // Tickets should only show for valid pending or joined. 
              // Auto-skipped items should hide ticket info as well.
